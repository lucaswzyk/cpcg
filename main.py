...
With the following commands we can access a dMRI dataset
"""
...
dname = ('C:/Data/Data/Diffusion_MRI_data/ADNI/002_S_1261')

"""
Here, we show the complete filenames of the 3 files
"""

fdwi = join(dname, '20180424_082009AxialDTIs007a001.nii.gz')

print(fdwi)

fbval = join(dname, '20180424_082009AxialDTIs007a001.bval')

print(fbval)

fbvec = join(dname, '20180424_082009AxialDTIs007a001.bvec')
...
plt.imshow(data[:, :, axial_middle, 0].T, origin='lower')
plt.subplot(1, 2, 2).set_axis_off()
plt.imshow(data[:, :, axial_middle, 10].T, origin='lower')
plt.show()
